                                                            ...
                                                            <div className="flex-grow flex flex-col">
                                                                ...
                                                                <div className="mt-auto flex justify-between">
                                                                    ...
                                                                    <div className="flex space-x-3">
                                                                        <div 
                                                                            className={`flex flex-col items-center justify-center cursor-pointer group ${compareProducts.some(p => p.id === product.id) ? 'text-green-500' : ''}`}
                                                                            onClick={(e) => {
                                                                                e.preventDefault();
                                                                                handleCompare(product.id, e);
                                                                            }}
                                                                        >
                                                                            <BarChart2 className={`h-4 w-4 ${compareProducts.some(p => p.id === product.id) ? 'text-green-500' : 'text-zinc-400 group-hover:text-green-500'} transition-colors`} />
                                                                        </div>
                                                                        <div 
                                                                ...
                                                                <div className="hidden sm:flex sm:justify-end sm:mt-2 sm:space-x-4 sm:text-xs sm:text-zinc-400">
                                                                    <span className={compareProducts.some(p => p.id === product.id) ? 'text-green-500' : ''}>Compare</span>
                                                                    <span>Track</span>
                                                                    <span>Save</span>
                                                                    <span>Details</span>
                                                                </div>
